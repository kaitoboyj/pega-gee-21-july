...
const Ovt = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section className="relative pt-32 sm:pt-40 md:pt-44 pb-12 sm:pb-16 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            <div className="inline-block p-1 rounded-full bg-gradient-to-r from-silver-700 to-silver-400 mb-8 shadow-[0_0_40px_hsl(0,0,75%,0.4)]">
              <img
                src={ovtImage}
                alt="$OVT"
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-silver/10 border border-silver/30 mb-4">
              <span className="text-xs sm:text-sm font-semibold text-silver-400">OpenVerse Token</span>
            </div>
